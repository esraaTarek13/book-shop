  ...
  return (
    <>
      ...
      <section className="flex gap-4 md:gap-6">
        <div className="bg-surface lg:bg-transparent border-r border-card-border py-8 md:py-10 px-2 md:px-4 lg:pr-4 lg:pl-10">
          <FilterSidebar {...filterProps} />
          <FilterDrawer {...filterProps} />
        </div>

        <div className="custom-container flex-1 grow space-y-10 md:space-y-20 py-8 md:py-10">
